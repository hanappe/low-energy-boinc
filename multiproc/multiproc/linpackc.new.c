...
static REAL linpack(long nreps, int arsize, void *mempool, computation_data_t* d);
...
static REAL linpack(long nreps, int arsize, void *mempool, computation_data_t* d)
{
    ...
    if (toverhead<0.)
        toverhead=0.;
    fprintf(d->out, "%8ld %6.2f %6.2f%% %6.2f%% %6.2f%%  %9.3f\n",
